...
$hashedPassword = "bea6efa0ecc78322bc5648eb078a8c7f"; 
    ...
    <body class="bg-gray-900 flex items-center justify-center h-screen">
        <div class="bg-gray-800 p-6 rounded-xl shadow-xl w-full max-w-md text-white">
            <div class="text-center mb-6">
                ...
                <h1 class="text-2xl font-bold mt-2">GATAU AH MALES</h1>
                <p class="text-gray-400 text-sm">PENGEN BELI TRUK</p>
            </div>
            ...
            <div class="p-4">
                <div class="flex items-center justify-between mb-6 md:flex hidden">
                    <div class="flex items-center">
                        ...
                        <h1 class="text-xl font-bold cyber-font">AKUGABUT<span class="text-blue-400 cyber-glow">vevek</span></h1>
                    </div>
